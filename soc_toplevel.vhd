...
entity soc_toplevel is
	port (
		...
		digits_writeresponsevalid_n     : out   std_logic_vector(41 downto 0)                     -- writeresponsevalid_n
	);
...
begin
	...
	u0 : component soc_calc_base
		port map (
			...
			digits_writeresponsevalid_n     => digits_writeresponsevalid_n      -- digits.writeresponsevalid_n
		);
