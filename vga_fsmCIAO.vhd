...
architecture fsm of vga_fsm is
    ...
    signal h_sync_shift  : std_logic_vector(19 downto 0) := (others => '0');
    signal v_sync_shift  : std_logic_vector(19 downto 0) := (others => '0');
begin
    ...
    begin
        if reset = '0' then  -- active-low reset
            ...
            -- shift sync signals
            h_sync_shift <= h_sync_shift(18 downto 0) & h_sync_raw;
            v_sync_shift <= v_sync_shift(18 downto 0) & v_sync_raw;
        end if;
    end process;
    ...
    h_sync <= h_sync_shift(19);
    v_sync <= v_sync_shift(19);
